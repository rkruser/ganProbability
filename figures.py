...
def cifar10Numerical():
    ...
    cifar32 = cifar32loader.getDataset(outShape = (3,32,32), distribution=None, labels=None, mode='test', returnLabel = True)
    ...
    if not osp.exists('./generated/e67/data/probsPixel.pickle'):
        ...
        print "Dumping pixel"
        pickle.dump(probsPixel,open('./generated/e67/data/probsPixel.pickle','w')) 
        print "Dumping deep"
        pickle.dump(probsDeep,open('./generated/e67/data/probsDeep.pickle','w')) 
