...
from models import _netF, prob_data, weights_init, mog_netP
...
def main():
    ...
    trainset = prob_data(root=opt.dataroot, train=True, label=opt.classindex)
    testset = prob_data(root=opt.dataroot, train=False, label=opt.classindex)
