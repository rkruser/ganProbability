...
from code.models import _netP, prob_data, generate_outlierexp_data, generate_classwise_data
...
class RegressorRun(Operator):
  def __init__(self, config, args):
    super(RegressorRun,self).__init__(config, args)
    opt = {
      'netP':'netP',
      'netPinstance':-1,
      'netPexpNum':-1,
