...
python sample.py --model codeRegressor --dataset mnist --saveDir generated/final/codeRegressor/mnistSample --netR generated/final/codeRegressor/netR_50.pth --samplePrefix mnistCodeRegressorTrain --sampleFunc sampleCodes --datamode train
