...
python sample.py --model DeepGAN10 --sampleFunc backprop --saveDir generated/final/deepgan/cifar10 --modelroot generated/final/deepgan/cifar10 --netG generated/final/deepgan/cifar10/netG_20.pth --netD generated/final/deepgan/cifar10/netD_20.pth --nsamples 10000 --nz 10 --samplePrefix samplesDeep_${SLURM_ARRAY_TASK_ID}
